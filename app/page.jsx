...
export default function App() {
  ...
  const headerColumns = useMemo(() =>
    visibleColumns === "all"
      ? columns
      : columns.filter((c) => Array.from(visibleColumns).includes(c.uid)),
    [visibleColumns]
  );
  ...
  const [visibleColumnsModal2, setVisibleColumnsModal2] = useState(new Set(INITIAL_VISIBLE_COLUMNS_MODAL2));
  ...
  const [visibleColumnsModal3, setVisibleColumnsModal3] = useState(new Set(INITIAL_VISIBLE_COLUMNS_MODAL3));
  ...
  const [visibleColumnsModal4, setVisibleColumnsModal4] = useState(new Set(INITIAL_VISIBLE_COLUMNS_MODAL4));
        ...
        case "actions":
          return (
            <UserActionsDropdown
              ...
              setSelectedUserPublicKey={setSelectedUserPublicKey}
  ...
  const handleFileInput = useCallback((e) => {
    ...
    reader.onload = (event) => setKeyInput(event.target.result);
  ...
  return (
    <>
      ...
      <Table
        ...
        sortDescriptor={mainTable.sortDescriptor}
        topContent={topContent}
        topContentPlacement="outside"
        onSortChange={mainTable.setSortDescriptor}
      >
      ...
      <ManageUserIDsModal
        ...
        sortDescriptor={manageUserIDsTable.sortDescriptor}
        setSortDescriptor={manageUserIDsTable.setSortDescriptor}
        ...
        onSetPrimary={(user, row) =>
          ops.setPrimaryUserID(user, row, { setModalUserIDs })
        }
      ...
      <RevokeUserIDModal
        ...
        onConfirm={() =>
          ops.revokeUserID(selectedUserId, userIDToRevoke, { setModalUserIDs })
        }
      />
      ...
      <CertifyKeyModal
        ...
        sortDescriptor={certifyTable.sortDescriptor}
        setSortDescriptor={certifyTable.setSortDescriptor}
      ...
      <ManageSubkeyModal
        ...
        sortDescriptor={subkeyTable.sortDescriptor}
        setSortDescriptor={subkeyTable.setSortDescriptor}
        ...
        onBackupSubkey={ops.backupSubkey}
      ...
      <ViewCertificationsModal
        ...
        sortDescriptor={certViewTable.sortDescriptor}
        setSortDescriptor={certViewTable.setSortDescriptor}
