...
export const deriveKey = async (password, salt, iterations = DEFAULT_ITERATIONS) => {
...
export const extractSalt = (base64Data) => {
...
export const deriveMasterKey = async (password, salt, iterations = DEFAULT_ITERATIONS) => {
  let saltBytes;
  if (salt) {
...
export const decrypt = async (base64Data, options = {}) => {
  try {
    const data = fromBase64(base64Data);
