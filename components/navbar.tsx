    ...
    >
      ...
      <NavbarContent className="hidden lg:flex gap-4 ms-12" justify="center">
        <Dropdown>
          ...
          >
            <DropdownItem key="manage-keyrings" textValue="Manage Keyrings">
            ...
            <DropdownItem key="generate-keyrings" textValue="Generate Keyrings">
            ...
            <DropdownItem key="import-key" textValue="Import Key">
      ...
      <NavbarContent className="hidden lg:flex gap-4" justify="center">
        <Dropdown>
          ...
          >
            <DropdownItem key="encrypt" textValue="Encrypt">
            ...
            <DropdownItem key="decrypt" textValue="Decrypt">
      ...
      <NavbarContent className="hidden lg:flex gap-4" justify="center">
        <Dropdown>
          ...
          >
            <DropdownItem key="backup" textValue="Backup">
              <NProgressLink
            ...
            <DropdownItem key="import-cloud" textValue="Import">
              <NProgressLink
                className="text-decoration-none"
                href="/cloud-manage"
              >
